...
module Lunation
  class Calculation
    module SunPosition
      ...
      # UNIT: Angle
      def calculate_sun_mean_longitude
      ...
      def calculate_earth_orbit_eccentricity
        Horner.compute(time, [0.016708634, -0.000042037, -0.0000001267]).round(9)
      end

      # (C) Sun's equation of the center (A.A. p. 164)
      # UNIT: Angle
      def calculate_sun_equation_of_center(sun_mean_anomaly: calculate_sun_mean_anomaly2)
      ...
      # UNIT: Angle
      def calculate_sun_anomaly(
        sun_mean_anomaly: calculate_sun_mean_anomaly2,
        sun_equation_of_center: calculate_sun_equation_of_center
      )
        sun_mean_anomaly + sun_equation_of_center
      end

      # (R) earth_sun_distance (25.5, A.A. p. 164)
      # UNIT: Astronomical Units (AU)
      def calculate_distance_between_earth_and_sun_in_astronomical_units(
      ...
      # (R) earth_sun_distance (25.5, A.A. p. 164)
      # UNIT: Kilometers (km)
      def calculate_distance_between_earth_and_sun_in_kilometers(
      ...
      #   A.A. p. 164
      # UNIT: Angle
      def calculate_longitude_of_ascending_node_low_precision
        Angle.from_decimal_degrees(125.04 - 1934.136 * time)
      end

      # (apparent λ0) Sun apparent longitude (A.A. p. 169)
      # UNIT: Angle
      def calculate_sun_ecliptic_longitude(
        ...
        result = sun_true_longitude.decimal_degrees +
          - 0.00569 +
          - 0.00478 * Math.sin(longitude_of_ascending_node.radians)
        Angle.from_decimal_degrees(result)
      end

      # (corrected ε) corrected true obliquity of the ecliptic (A.A. p. 165)
      # UNIT: Angle
      def calculate_corrected_obliquity_of_ecliptic(
      ...
      # UNIT: Angle
      def calculate_sun_right_ascension(
